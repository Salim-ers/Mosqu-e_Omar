...
import { getAllAnnouncements, isActive } from "@/lib/announcements";
import { getSiteArticles } from "@/lib/content";
...
export default async function ActualitesPage() {
  const [articles, wordpressPosts, announcements] = await Promise.all([
    getSiteArticles(),
    getPosts({ perPage: 12 }),
    getAllAnnouncements(),
  ]);

  // Les articles rédigés dans l'espace bénévoles font foi ; ceux du WordPress
  // complètent la liste tant que l'association y publie encore.
